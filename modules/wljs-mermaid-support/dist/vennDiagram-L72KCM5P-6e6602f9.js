import { b7 as adjustChannel, _ as __name, E as defaultConfig_default, F as cleanAndMerge, G as getConfig, s as setAccTitle, g as getAccTitle, n as setDiagramTitle, o as getDiagramTitle, b as getAccDescription, c as setAccDescription, v as clear, K as selectSvgElement, j as select, ao as at, Y as isDark, $ as lighten, a0 as darken, k as configureSvgSize } from './mermaid.core-ad8d5d2d.js';
...
/* EXPORT */
var transparentize$1 = transparentize;
...
var draw = /* @__PURE__ */ __name((_text, id, _version, diagObj) => {
  ...
  const dummyD3root = select(document.createElement("div"));
    ...
    if (isHandDrawn && roughSvg) {
      ...
      if (layoutArea && layoutArea.circles.length > 0) {
        ...
        const roughNode = roughSvg.circle(c.x, c.y, c.radius * 2, {
          roughness: 0.7,
          seed: handDrawnSeed,
          fill: transparentize$1(baseColor, 0.7),
          fillStyle: "hachure",
          fillWeight: 2,
          hachureGap: 8,
      ...
      if (customFill) {
        ...
        if (pathD) {
          const roughNode = roughSvg.path(pathD, {
            roughness: 0.7,
            seed: handDrawnSeed,
            fill: transparentize$1(customFill, 0.3),
