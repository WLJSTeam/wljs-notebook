import { A as isSymbol, a as isObject, c as isArrayLike, B as isIndex, e as eq, C as baseRest, D as baseFlatten, E as setToString, F as overRest, l as isObjectLike, H as baseGetTag, r as root, q as isArray, t as isBuffer, I as isTypedArray, J as isArrayLikeObject, K as isArguments, L as isFunction, M as baseFor, u as Stack, z as baseIteratee, k as keys, N as baseFindIndex, O as castFunction, P as baseForOwn, Q as hasPath, R as identity, T as castPath, V as toKey, W as baseGet, y as arrayMap, p as baseUnary, X as hasIn, Y as toString, Z as forEach, G as Graph, _ as constant, i as isUndefined, $ as filter, a0 as values, a1 as reduce } from './graph-bc133f60.js';
import { g as getPrototype, b as baseClone, k as keysIn, a as baseAssignValue, c as copyObject, d as copyArray, e as cloneBuffer, f as cloneTypedArray, i as initCloneObject, h as assignValue, j as baseMap, m as map } from './map-1b52cc59.js';
...
function enterEdge(t, g, edge) {
  ...
  var candidates = filter(g.edges(), function (edge) {
    return (
    ...
    if (node.rank === rank || (node.minRank <= rank && rank <= node.maxRank)) {
      ...
      forEach(g[relationship](v), function (e) {
        var u = e.v === v ? e.w : e.v,
          ...
          weight = !isUndefined(edge) ? edge.weight : 0;
...
function doResolveConflicts(sourceSet) {
  ...
  function handleIn(vEntry) {
    return function (uEntry) {
      ...
      if (
        isUndefined(uEntry.barycenter) ||
        isUndefined(vEntry.barycenter) ||
