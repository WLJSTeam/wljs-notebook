...
template = StringTemplate["<video width=\"auto\" height=\"auto\" preload=\"metadata\" controls class=\"rounded wljs-canvas\" style=\"vertical-align:middle; max-width:1024px;\"><source src=\"/downloadFile/?path=``\"/></video>"]
