                    ...
                    With[{string = ToString[result, StandardForm]},
                        ...
                        ,
                            With[{
                                ...
                                EventFire[Internal`Kernel`RemoteEvent[ t["Hash"] ], "Result", <|"Data" -> StringTemplate[Internal`Kernel`TruncatedOutputTemplate][ToString[NumberForm[Round[StringLength[string]/1024/1024//N, 0.01], {3,2}]], StringReplace[StringTake[shortform, Min[StringLength[shortform], 5000]], {">"->"&gt;", "<"->"&lt;"} ], ref, ref, ref ], "Overflow"->True, "Meta"->Sequence["Hash"->hash, "Display"->"html", "Overflow"->True, "OverflowContent"->inputform] |> ];
                            ]
                        ]
                    ]
